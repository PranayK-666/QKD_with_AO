classdef controller < handle
    ...
    methods
        ...
        function obj = controller(sensor,compensator,nIteration,varargin)
            ...
            obj.tipTiltCompensatorData = zeros(2,obj.nTipTiltSensor,obj.nIteration+obj.delay+1);
...
%         end
        ...
        function closedLoopWithtTipTiltComp(obj,~,~) % obj, src, event
            ...
            obj.sensorData(:,:,obj.kIteration+obj.delay+1)           = obj.sensor.slopes;
            % TT WFS
            obj.tipTiltSensorData(:,:,obj.kIteration+obj.delay+1)    = obj.sensor.meanSlopes;
            % DM
            obj.compensatorData(:,obj.kIteration+obj.delay+1)        = obj.compensator.coefs;
            % TT Mirror
            obj.tipTiltCompensatorData(:,obj.kIteration+obj.delay+1) = obj.tipTiltCompensator.coefs;
            
            obj.compensator.coefs       = obj.compensator.coefs - ...
                obj.gain*obj.M*obj.sensorData(:,:,obj.kIteration);
            
            obj.tipTiltCompensator.coefs = obj.tipTiltCompensator.coefs - ...
        ...
        function closedLoopWithtTipTiltSensComp(obj,~,~) % obj, src, event
            ...
            obj.sensorData(:,:,obj.kIteration+obj.delay+1)           = obj.sensor.slopes;
            % TT WFS
            obj.tipTiltSensorData(:,:,obj.kIteration+obj.delay+1)    = obj.tipTiltSensor.slopes;
