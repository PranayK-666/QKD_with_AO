classdef photometry
    ...
    enumeration
        ...
        % for QKD simulation 
        GREEN ( 0.532e-6 , 0        , 3.3e12 ) %NM
        FSOC_L1 ( 1.064e-6 , 0        , 3.3e12 ) %NM
        FSOC_L2 ( 1.550e-6 , 0        , 3.3e12 ) %NM
        FSOC_Q1 ( 0.850e-6 , 0        , 3.3e12 ) %NM
        FSOC_Q2 ( 0.810e-6 , 0        , 3.3e12 ) %NM
        FSOC_Q3 ( 0.770e-6 , 0        , 3.3e12 ) %NM
