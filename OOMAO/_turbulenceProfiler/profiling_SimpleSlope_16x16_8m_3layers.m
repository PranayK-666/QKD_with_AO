...
if ~flagTT
    save('-ascii',sprintf('result/cross_profile_FFT_vs_Hudgin_%02d.txt',L0),'a');
else
    save('-ascii',sprintf('result/cross_profile_FFT_vs_Hudgin_%02d_woTT.txt',L0),'a');
end
...
if ~flagTT
    fp = fopen(sprintf('result/output_FFT_vs_Hudgin_%02d.txt',L0),'w');
else
    fp = fopen(sprintf('result/output_FFT_vs_Hudgin_%02d_woTT.txt',L0),'w');
end
fp=1;
